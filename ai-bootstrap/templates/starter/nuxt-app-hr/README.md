...
> 已验证版本：nuxt ^4.0.0 / @nuxt/ui ^4.0.0 / tailwindcss ^4.3.0 / @nuxt/icon ^2.4.0 / vue-tsc ^3.3.9 / @fontsource-variable/inter ^5.2.0。
...
- 字体加载：`app/plugins/fonts.ts` + main.css 的 fontsource import。
